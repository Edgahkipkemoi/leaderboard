...
Its a JavaScript project, creating a Leaderboard list app, using webpack and ES6.
...
1. A Web browser.
2. A Code editor
3. A Version control sytem(Gt-msc)
...
` git clone https://github.com/Edgahkipkemoi/leaderboard.git`
...
- GitHub: [@githubhandle](https://github.com/Edgahkipkemoi)
...
Feel free to check the [issues page](https://github.com/Edgahkipkemoi/leaderboard/issues).
